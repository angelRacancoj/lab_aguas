...
<head>
  ...
  <title>Editar Paquete | Laboratorio de aguas</title>
...
<body>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Paquete</h3>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Busqueda<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="fullname"  type="text" required placeholder="Introduce el nombre del parametro que editaras" />
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Nombre del Paquete <span class="required">*</span></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Costo del paquete <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="fullname"  type="text" required />
                      </div>
                    </div>
