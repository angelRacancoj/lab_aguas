...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Realizar Compra de Equipo | Laboratorio de aguas</title>
  ...
  <body>
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Realizar Compra de Equipo</h3>
                  ...
                  <form class="form-validate form-horizontal" id="feedback_form" action="#" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <select class="form-control m-bot15" name="position" type="text" required >
                          <?php
                            /*foreach (getAllEquipment() as $position) {
                                  echo '<option value="'.$position->getIdEquipment().'">'.$position->getNameEquipment().'</option>';
                            }*/
                           ?>
                        </select>
                      </div>
