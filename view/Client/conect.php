...
function createClient($dpi,$name,$phone,$costum_id){
	...
	$sql = "INSERT INTO `water_laboratory`.`CLIENT` (`dpi_client`, `name_client`, `phone_client`, `costum_client_id`) VALUES ($dpi,$name,$direction,$department,$company,$phone,$extra_phone,$fax,$email,$web,$costum);";
